...
export const PLATFORM_MASTER: PlatformMaster[] = [
  ...
  { id: "google_pmax", name: "P-MAX", color: "#34A853", icon: "PM", bg: "#E6F4EA", parent: "Google", sortOrder: 2 },
  { id: "yahoo_search", name: "Yahoo! 検索広告", color: "#FF0033", icon: "YS", bg: "#FFF0F3", parent: "Yahoo!", sortOrder: 3 },
  { id: "yahoo_display", name: "Yahoo! ディスプレイ", color: "#7B0099", icon: "YD", bg: "#F5E6FF", parent: "Yahoo!", sortOrder: 4 },
